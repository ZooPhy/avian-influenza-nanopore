...
WORK = HERE / "work"
SOURCE = WORK / "source"
PROJECT = WORK / "results" / "release_smoke" / "irma" / "project"
DB = WORK / "blastdb" / "phase13"
...
rule build_irma_boundary_fixture:
    input:
        upstream=WORK / "results" / "release_smoke" / "fastplong" / "filtered_renamed.fastq.gz",
    ...
    shell:
        ...
        # Requiring the renamed production FASTQ makes this stub boundary
        # explicitly downstream of Porechop -> fastplong -> seqtk.
        test -s {input.upstream:q}
