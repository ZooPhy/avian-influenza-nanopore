...
def main() -> None:
    ...
    for segment in SEGMENTS:
        ...
        consensus_length = stats_row.get("consensus_length") or manifest_row.get("fasta_length") or "0"
        ...
        candidate_count = manifest_row.get("candidate_count") or stats_row.get("n_candidates") or "0"
        try:
        ...
        selection_status = (
            ...
            or stats_row.get("selection_status")
            or ("MULTIPLE_CANDIDATES" if candidate_count_int > 1 else "UNIQUE" if candidate_count_int == 1 else "MISSING")
        )

        rows.append({
            "sample": sample,
            "segment": segment,
            "contig": stats_row.get("selected_contig") or stats_row.get("chosen_table") or manifest_row.get("contig") or "NA",
            ...
            "candidate_count": str(candidate_count_int),
    ...
    fieldnames = [
        ...
        "median_depth", "mean_depth", "breadth_covered", "n_count", "n_fraction",
        "expected_length_min", "expected_length_max", "maximum_n_fraction",
        "coverage_status", "length_status", "n_content_status", "overall_status",
        "coverage_flag", "assembly_status", "candidate_count", "selection_status",
